    ...
    <div className="container py-10">
      <div className="mx-auto max-w-md space-y-6">
        <div className="space-y-2 text-center">
          ...
          <p className="text-muted-foreground">Silakan isi formulir di bawah ini untuk mengajukan pembayaran pajak.</p>
        </div>

        <Card>
          <CardHeader>
            <CardTitle>Detail Pengajuan</CardTitle>
            <CardDescription>Masukkan informasi pajak yang akan dibayarkan.</CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <SelectContent>
                          <SelectItem value="Pajak Penghasilan">Pajak Penghasilan</SelectItem>
                          <SelectItem value="Pajak Kendaraan">Pajak Kendaraan</SelectItem>
                          <SelectItem value="Pajak Bumi dan Bangunan">Pajak Bumi dan Bangunan</SelectItem>
                          <SelectItem value="Pajak Pertambahan Nilai">Pajak Pertambahan Nilai</SelectItem>
                        </SelectContent>
                      </Select>
                      <FormDescription>Pilih jenis pajak yang ingin Anda bayarkan.</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Masukkan jumlah pajak dalam Rupiah (tanpa titik atau koma).</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />

                <Alert variant="outline" className="border-blue-200 bg-blue-50 dark:border-blue-900 dark:bg-blue-950">
                  <AlertCircle className="h-4 w-4 text-blue-600 dark:text-blue-400" />
                  <AlertTitle>Informasi</AlertTitle>
                  <AlertDescription>Pastikan data yang Anda masukkan sudah benar sebelum melanjutkan.</AlertDescription>
                </Alert>
